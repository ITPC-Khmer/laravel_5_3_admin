...
@section('title', _t('KP Category List'))
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-bell-o"></i>{{ _t('KP Category List') }} </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            <thead>
                            <tr>
                                <th style="width: 160px;">  <a href="{{ url('/cpanel/kp-category-form') }}" class="btn btn-outline btn-circle btn-sm purple">
                            ...
                            @foreach ($result as $row)
                                <tr>
                                    <td>
                                        {!! Form::open(['url' => "/cpanel/kp-category-form", 'method' => 'put']) !!}
        ...
        $(function () {
            $('body').delegate('.vm-del','click',function (e) {
                ...
                swal({
                    ...
                    function(){
                        $.ajax({
                            url : '{{ url('/cpanel/kp-category-delete') }}',
                            async : false,
                            data : {id : id},
                            error: function() {
                                swal({
