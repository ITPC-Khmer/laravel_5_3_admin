...
@section('title', _t('KP Category Form'))
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">{{ _t('KP Category Form') }}</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    {!! Form::open(['url' => 'cpanel/kp-category-save','class' => 'form-horizontal','role' => 'form']) !!}
