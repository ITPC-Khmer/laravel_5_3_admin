            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">{{ _t('Page Form') }}</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    {!! Form::open(['url' => 'cpanel/page-save','files' => true,'class' => 'form-horizontal form-class','role' => 'form']) !!}
                        ...
                        <div class="form-body">
                            ...
                            <div action="{{ url('/cpanel/page-upload') }}"
