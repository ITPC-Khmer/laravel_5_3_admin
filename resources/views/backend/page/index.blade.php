        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-bell-o"></i>{{ _t('Page List') }} </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            <thead>
                            <tr>
                                <th style="width: 160px;">  <a href="{{ url('/cpanel/page-form') }}" class="btn btn-outline btn-circle btn-sm purple">
                            ...
                            @foreach ($result as $row)
                                <tr>
                                    <td>
                                        {!! Form::open(['url' => "/cpanel/page-form", 'method' => 'put']) !!}
                                    ...
                                    <td class="highlight">
                                        ...
                                        <a href="javascript:"> {!! highlight(json_decode($row->title)->en,$title) !!} </a>
                                    </td>
                                    <td class="hidden-xs"> {!! highlight(json_decode($row->description)->en,$description) !!} </td>
