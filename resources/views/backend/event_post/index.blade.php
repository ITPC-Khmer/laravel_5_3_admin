...
@section('title', _t('Event Post List'))
        ...
        <div class="col-md-12">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-bell-o"></i>{{ _t('Event Post List') }} </div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table-scrollable">
                        <table class="table table-striped table-bordered table-advance table-hover">
                            <thead>
                            <tr>
                                <th style="width: 160px;">  <a href="{{ url('/cpanel/event-post-form') }}" class="btn btn-outline btn-circle btn-sm purple">
                            ...
                            @foreach ($result as $row)
                                <tr>
                                    <td>
                                        {!! Form::open(['url' => "/cpanel/event-post-form", 'method' => 'put']) !!}
                                    ...
                                    <td class="highlight">
                                        ...
                                        <a href="javascript:"> {!! isset(json_decode($row->title)->en)? highlight(json_decode($row->title)->en,$title):'' !!} </a>
                                    </td>
                                    <td class="hidden-xs"> {!! isset(json_decode($row->description)->en)? highlight(json_decode($row->description)->en,$description):'' !!} </td>
        ...
        $(function () {
            $('body').delegate('.vm-del','click',function (e) {
                ...
                swal({
                    ...
                    function(){
                        $.ajax({
                            url : '{{ url('/cpanel/event-post-delete') }}',
                            async : false,
                            data : {id : id},
                            error: function() {
                                swal({
