...
$event_type = isset($row)?$row->event_type:null;
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">{{ _t('Event Post Form') }}</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body form">
                    {!! Form::open(['url' => 'cpanel/event-post-save','files' => true,'class' => 'form-horizontal form-class','role' => 'form']) !!}

                        {!! Form::hidden('id',$id) !!}
                        <div class="form-body">

                            <div class="form-group form-md-line-input">
                                {!! Form::label('event_type', _t('Event Type'), ['class' => 'col-md-2 control-label']) !!}
                                <div class="col-md-10">
                                    ...
                                    <div class="input-group input-group-sm select2-bootstrap-prepend">
                                        ...
                                        {!! Form::select('event_type', event_posts_type(), $event_type,['id' => 'event_type','style'=>'display: none;','class' => 'form-control select2-multiple']) !!}
