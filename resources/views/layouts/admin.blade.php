                ...
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                    ...
                    <li class="nav-item  active open">
                        <a href="javascript:" class="nav-link nav-toggle">
                            ...
                            <span class="title">{{ _t('School') }}</span>
                        ...
                        <ul class="sub-menu">
                            ...
                            $arrMenu = [
                                ...
                                ['title' => 'KP Category','url' => 'cpanel/kp-category'],
                            ];
                    ...
                    <li class="nav-item  active open">
                        <a href="javascript:" class="nav-link nav-toggle">
                            <i class="icon-layers"></i>
                            <span class="title">{{ _t('Article') }}</span>
                            <span class="selected"></span>
                            <span class="arrow open"></span>
                        </a>
                        <ul class="sub-menu">
                            <?php
                            $arrMenu = [
                                ['title' => 'article page','url' => 'cpanel/page'],
                                ['title' => 'article post','url' => 'cpanel/post'],
                                ['title' => 'article category','url' => 'cpanel/category'],
                                ['title' => 'article tag','url' => 'cpanel/tag'],
                                ['title' => 'image-lib','url' => 'cpanel/image-lib'],
                            ];
                    ...
                    <li class="nav-item  active open">
                        <a href="javascript:" class="nav-link nav-toggle">
                            <i class="icon-layers"></i>
                            <span class="title">{{ _t('Admin') }}</span>
                            <span class="selected"></span>
                            <span class="arrow open"></span>
                        </a>
                        <ul class="sub-menu">
                            <?php
                            $arrMenu = [
                                ['title' => 'user','url' => 'cpanel/user'],
                                ['title' => 'role','url' => 'cpanel/role'],
                            ];
...
{{--
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> 2016 &copy; By
            <a target="_blank" href="http://camsmile.org">ITPC</a> &nbsp;
        </div>
...
<script>
    ...
    var url_rmv_file = '{{ url('/cpanel/post-remove-upload') }}';
</script>
<!--[if lt IE 9]>
