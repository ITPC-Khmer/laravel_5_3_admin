...
<head>
    ...
    <title>Event Grid - Universum</title>
...
<div id="pageloader">
    <div class="pageloader">
        ...
        <div class="textedit">
            <span class="site-name">Universum</span>
            <span class="site-tagline">HTML Education Template</span>
        </div>
    </div><!-- .pageloader -->
</div><!-- #pageloader -->
...
<div id="wrapper">
                    ...
                    <div class="col-md-4 col-sm-8 col-xs-9">
                        <div class="site-brand">
                            <a class="logo" href="index.html">
                                <img src="images/assets/logo.png" alt="Universum">
                            </a>
                        </div><!-- .site-brand -->
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="courses-fullwidth.html">Courses Fullwidth</a></li>
                                                    <li><a href="courses-list.html">Courses List</a></li>
                                                    <li><a href="courses-table.html">Courses Table</a></li>
                                                    <li><a href="courses-table-fullwidth.html">Courses Table Fullwidth</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <ul>
                                                    <li><a href="single-course.html">Single Courses Version 1</a></li>
                                                    <li><a href="single-course-v2.html">Single Courses Version 2</a></li>
                                                    <li><a href="single-course-v3.html">Single Courses Version 3</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <ul>
                                                    <li><a href="#">Master of Philosophy</a></li>
                                                    <li><a href="#">Master of Mathematics </a></li>
                                                    <li><a href="#">MBA</a></li>
                                                    <li><a href="#">Master of Physics</a></li>
                                                    <li><a href="#">Population Health Sciences</a></li>
                                                </ul>
                                            </div>
                                        </div><!-- .row -->
                                    </div><!-- .mega-menu -->
                                </li>
                                <li class="current-menu-item"><a href="event-grid.html">Events</a>
                                    <ul class="sub-menu">
                                        <li class="current-menu-item"><a href="event-grid.html">Event Grid</a></li>
    ...
    <div id="content" class="site-content">
        <div class="page-title parallax-window" data-parallax="scroll" data-image-src="images/placeholder/event-title.jpg">
            <div class="container">
                <h1>Event Grid</h1>
                ...
                <main id="main" class="site-main col-md-12">
                    ...
                    <div class="events layout column-3 isotope">
                        <div class="event isotope-item paid">
                            <div class="event-inner shadow">
                                <div class="event-thumb">
                                    <a class="mini-zoom" href="single-event.html"><img src="images/placeholder/event1.jpg" alt=""></a>
                                </div><!-- .event-thumb -->
                        ...
                        <div class="event isotope-item free">
                            <div class="event-inner shadow">
                                <div class="event-thumb">
                                    <a class="mini-zoom" href="single-event.html"><img src="images/placeholder/event2.jpg" alt=""></a>
                                </div><!-- .event-thumb -->
                        ...
                        <div class="event isotope-item free">
                            <div class="event-inner shadow">
                                <div class="event-thumb">
                                    <a class="mini-zoom" href="single-event.html"><img src="images/placeholder/event3.jpg" alt=""></a>
                                </div><!-- .event-thumb -->
                        ...
                        <div class="event isotope-item paid">
                            <div class="event-inner shadow">
                                <div class="event-thumb">
                                    <a class="mini-zoom" href="single-event.html"><img src="images/placeholder/event4.jpg" alt=""></a>
                                </div><!-- .event-thumb -->
                                ...
                                <div class="event-info">
                                    <h3 class="post-title"><a href="single-event.html">What are animals thinking?</a></h3>
                                    <ul class="event-meta">
                                        <li>At  8:30 am</li>
                                        <li>Brigde Campus, New York</li>
                                    </ul>
                        ...
                        <div class="event isotope-item paid">
                            <div class="event-inner shadow">
                                <div class="event-thumb">
                                    <a class="mini-zoom" href="single-event.html"><img src="images/placeholder/event5.jpg" alt=""></a>
                                </div><!-- .event-thumb -->
                                ...
                                <div class="event-info">
                                    <h3 class="post-title"><a href="single-event.html">College success in science</a></h3>
                                    <ul class="event-meta">
                                        <li>At  9:30 am</li>
                                        <li>Brigde Campus, New York</li>
                                    </ul>
                        ...
                        <div class="event isotope-item paid">
                            <div class="event-inner shadow">
                                <div class="event-thumb">
                                    <a class="mini-zoom" href="single-event.html"><img src="images/placeholder/event6.jpg" alt=""></a>
                                </div><!-- .event-thumb -->
                                ...
                                <div class="event-info">
                                    <h3 class="post-title"><a href="single-event.html">Teach teachers how to create magic</a></h3>
                                    <ul class="event-meta">
                                        <li>At  10:00 am</li>
                                        <li>Universum Campus, London</li>
                                    </ul>
                            ...
                            <div class="instargram">
                                <ul>
                                    <li><a href="#" target="_blank">
                                            <img src="images/placeholder/instargram1.jpg" alt="">
                                        </a></li>

                                    <li><a href="#" target="_blank">
                                            <img src="images/placeholder/instargram2.jpg" alt="">
                                        </a></li>

                                    <li><a href="#" target="_blank">
                                            <img src="images/placeholder/instargram3.jpg" alt="">
                                        </a></li>

                                    <li><a href="#" target="_blank">
                                            <img src="images/placeholder/instargram4.jpg" alt="">
                                        </a></li>

                                    <li><a href="#" target="_blank">
                                            <img src="images/placeholder/instargram5.jpg" alt="">
                                        </a></li>

                                    <li><a href="#" target="_blank">
                                            <img src="images/placeholder/instargram6.jpg" alt="">
                                        </a></li>
                                </ul>
                            </div><!-- .instargram -->
                        </div><!-- .widget -->
