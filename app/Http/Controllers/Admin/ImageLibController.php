...
class ImageLibController extends ControllerAdmin
{
    var $searchWords;
    var $k='';
    ...
    public function index(Request $request)
    {
        ...
        $_page = ImageLib::orderBy('image_libs.id','DESC');
        ...
        return view('backend.image_lib.index',array_merge(['result' => $pages],$q));
    ...
    function form(Request $request)
    {
        ...
        if($id - 0 > 0)
        {
            $row = ImageLib::find($id);
        }

        return view('backend.image_lib.form',['row' => $row]);
    }
    ...
    public function save(Request $request)
    {
        ...
        $page->image_lib_type = $request->input('image_lib_type');
        ...
        if($page->save()) {
            ...
            return redirect('cpanel/image-lib');
        }else{
