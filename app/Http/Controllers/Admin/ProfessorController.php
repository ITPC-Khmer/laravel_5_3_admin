...
class ProfessorController extends ControllerAdmin
{
    var $searchWords;
    var $k='';
    ...
    public function index(Request $request)
    {
        ...
        $_page = Professor::orderBy('professors.id','DESC');
        ...
        return view('backend.professor.index',array_merge(['result' => $pages],$q));
    ...
    function form(Request $request)
    {
        ...
        if($id - 0 > 0)
        {
            $row = Professor::find($id);
        }

        return view('backend.professor.form',['row' => $row]);
    }
    ...
    public function save(Request $request)
    {
        ...
        $page->professor_type = $request->input('professor_type');
        ...
        if($page->save()) {
            ...
            return redirect('cpanel/professor');
        }else{
